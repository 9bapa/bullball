...
import { chainService, CreateChainRequest } from '@/services/chain.service'
...
export default function AddChainPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const chainData: CreateChainRequest = {
      ...
      const errorMsg = `Failed to create chain: ${error instanceof Error ? error.message : 'Unknown error'}`
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">Add a new blockchain to your network</p>
                  </div>
                </div>
                ...
                {success && (
                  <Card className="border-green-500/50 bg-green-500/10">
                    <CardContent className="p-6 text-center">
                      ...
                      <h3 className="text-lg font-medium mb-2">Chain Created Successfully!</h3>
                ...
                {!success && (
                  <Card className="border-primary/20">
                    <CardHeader>
                      ...
                      <CardDescription>
                        Enter chain details. All fields marked with * are required.
                      </CardDescription>
                    </CardHeader>
                      ...
                      <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="space-y-2">
                          ...
                          <p className="text-xs text-muted-foreground ml-7">
                            When enabled, this chain will be available for use in the platform
                          </p>
                        </div>
                        ...
                        <div className="flex justify-end gap-3">
                          ...
                          >
                            ...
                            {loading ? 'Creating Chain...' : 'Create Chain'}
                          </Button>
                        </div>
                      </form>
                    </CardContent>
        ...
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
          <div className="bg-card border border-primary/20 rounded-xl p-8 max-w-md w-full">
            <div className="text-center space-y-6">
              ...
              <div>
                <h3 className="text-xl font-bold mb-2">Chain Created Successfully!</h3>
                <p className="text-muted-foreground">
                  The chain "{formData.name}" has been successfully added to your network.
                </p>
              </div>
        ...
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
          <div className="bg-card border border-red-500/30 rounded-xl p-8 max-w-md w-full">
            <div className="text-center space-y-6">
              ...
              <div>
                <h3 className="text-xl font-bold mb-2">Error Creating Chain</h3>
                <p className="text-muted-foreground">
                  {errorMessage}
                </p>
              </div>
